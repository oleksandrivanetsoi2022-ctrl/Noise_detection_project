...
/* Generated by nanopb-0.3.9.1 at Tue Jun 03 15:06:49 2025. */
...
typedef enum _EnumLowLevelIO {
    ...
    EnumLowLevelIO_IO_HEADER_SIZE_MSK = 32767,
    EnumLowLevelIO_IO_IN_PACKET_SIZE = 32,
    EnumLowLevelIO_IO_OUT_PACKET_SIZE = 32,
    EnumLowLevelIO_IO_IN_PACKET_SIZE_LARGE = 4094,
    EnumLowLevelIO_IO_OUT_PACKET_SIZE_LARGE = 4094,
...
typedef enum _EnumAiApiRuntime {
    EnumAiApiRuntime_AI_RT_API_NONE = 0,
    EnumAiApiRuntime_AI_RT_API_ST_AI = 1,
    EnumAiApiRuntime_AI_RT_API_LITE = 2,
    EnumAiApiRuntime_AI_RT_API_RELOC = 4,
    EnumAiApiRuntime_AI_RT_API_POS = 8
} EnumAiApiRuntime;
#define _EnumAiApiRuntime_MIN EnumAiApiRuntime_AI_RT_API_NONE
#define _EnumAiApiRuntime_MAX EnumAiApiRuntime_AI_RT_API_POS
#define _EnumAiApiRuntime_ARRAYSIZE ((EnumAiApiRuntime)(EnumAiApiRuntime_AI_RT_API_POS+1))
...
typedef enum _EnumTools {
    ...
    EnumTools_AI_HTC = 5,
    EnumTools_AI_GHS = 6,
    EnumTools_AI_TOOLS_POS = 16
} EnumTools;
#define _EnumTools_MIN EnumTools_AI_GCC
#define _EnumTools_MAX EnumTools_AI_TOOLS_POS
#define _EnumTools_ARRAYSIZE ((EnumTools)(EnumTools_AI_TOOLS_POS+1))
...
typedef enum _EnumCounterFormat {
    EnumCounterFormat_COUNTER_FMT_64B = 0,
    EnumCounterFormat_COUNTER_FMT_32B = 1,
    EnumCounterFormat_COUNTER_FMT_MASK = 65535,
    EnumCounterFormat_COUNTER_FMT_POS = 16
} EnumCounterFormat;
#define _EnumCounterFormat_MIN EnumCounterFormat_COUNTER_FMT_64B
#define _EnumCounterFormat_MAX EnumCounterFormat_COUNTER_FMT_POS
#define _EnumCounterFormat_ARRAYSIZE ((EnumCounterFormat)(EnumCounterFormat_COUNTER_FMT_POS+1))

typedef enum _EnumCounterType {
    EnumCounterType_COUNTER_TYPE_CPU = 0,
    EnumCounterType_COUNTER_TYPE_MASK = 65535
} EnumCounterType;
#define _EnumCounterType_MIN EnumCounterType_COUNTER_TYPE_CPU
#define _EnumCounterType_MAX EnumCounterType_COUNTER_TYPE_MASK
#define _EnumCounterType_ARRAYSIZE ((EnumCounterType)(EnumCounterType_COUNTER_TYPE_MASK+1))
...
typedef enum _EnumRunParam {
    ...
    EnumRunParam_P_RUN_CONF_CONST_VALUE = 512,
...
typedef enum _EnumShapeFmt {
    ...
    EnumShapeFmt_F_SHAPE_FMT_ST_AI = 4,
    EnumShapeFmt_F_SHAPE_FMT_RAW = 5,
    EnumShapeFmt_F_SHAPE_FMT_CHANNEL_FIRST = 16,
    EnumShapeFmt_F_SHAPE_FMT_CHANNEL_LAST = 32,
    EnumShapeFmt_F_SHAPE_FMT_HAS_BATCH = 64,
    EnumShapeFmt_F_SHAPE_FMT_POS = 24
} EnumShapeFmt;
#define _EnumShapeFmt_MIN EnumShapeFmt_F_SHAPE_FMT_UND
#define _EnumShapeFmt_MAX EnumShapeFmt_F_SHAPE_FMT_POS
#define _EnumShapeFmt_ARRAYSIZE ((EnumShapeFmt)(EnumShapeFmt_F_SHAPE_FMT_POS+1))
...
typedef enum _EnumDataFmtType {
    ...
    EnumDataFmtType_DATA_FMT_TYPE_FXP = 15
} EnumDataFmtType;
#define _EnumDataFmtType_MIN EnumDataFmtType_DATA_FMT_TYPE_NONE
#define _EnumDataFmtType_MAX EnumDataFmtType_DATA_FMT_TYPE_FXP
#define _EnumDataFmtType_ARRAYSIZE ((EnumDataFmtType)(EnumDataFmtType_DATA_FMT_TYPE_FXP+1))
...
typedef enum _EnumDataType {
    ...
    EnumDataType_DATA_TYPE_POS = 24
} EnumDataType;
#define _EnumDataType_MIN EnumDataType_DATA_TYPE_NONE
#define _EnumDataType_MAX EnumDataType_DATA_TYPE_POS
#define _EnumDataType_ARRAYSIZE ((EnumDataType)(EnumDataType_DATA_TYPE_POS+1))
...
typedef enum _EnumOperatorFlag {
    ...
    EnumOperatorFlag_OPERATOR_FLAG_POS = 24
} EnumOperatorFlag;
#define _EnumOperatorFlag_MIN EnumOperatorFlag_OPERATOR_FLAG_NONE
#define _EnumOperatorFlag_MAX EnumOperatorFlag_OPERATOR_FLAG_POS
#define _EnumOperatorFlag_ARRAYSIZE ((EnumOperatorFlag)(EnumOperatorFlag_OPERATOR_FLAG_POS+1))
...
#define aiOperatorMsg_init_default               {"", 0, 0, 0, 0, {{NULL}, NULL}, 0, 0}
...
#define sysinfoMsg_init_default                  {0, 0, 0, 0, 0, {{NULL}, NULL}}
...
#define aiOperatorMsg_init_zero                  {"", 0, 0, 0, 0, {{NULL}, NULL}, 0, 0}
...
#define sysinfoMsg_init_zero                     {0, 0, 0, 0, 0, {{NULL}, NULL}}
...
#define aiModelInfoMsg_runtime_desc_tag          20
...
#define aiOperatorMsg_stack_used_tag             7
#define aiOperatorMsg_heap_used_tag              8
...
#define sysinfoMsg_com_param_tag                 5
#define sysinfoMsg_extra_tag                     6
...
extern const pb_field_t aiOperatorMsg_fields[9];
extern const pb_field_t aiTensorMsg_fields[3];
extern const pb_field_t aiModelInfoMsg_fields[18];
extern const pb_field_t syncMsg_fields[4];
extern const pb_field_t sysinfoMsg_fields[7];
...
/* sysinfoMsg_size depends on runtime parameters */
#define ackMsg_size                              8
#define logMsg_size                              137
#define respMsg_size                             (8 + (((((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) > aiOperatorMsg_size ? ((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) : aiOperatorMsg_size) > aiDataMsg_size ? (((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) > aiOperatorMsg_size ? ((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) : aiOperatorMsg_size) : aiDataMsg_size) > 140 ? ((((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) > aiOperatorMsg_size ? ((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) : aiOperatorMsg_size) > aiDataMsg_size ? (((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) > aiOperatorMsg_size ? ((sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) > aiTensorMsg_size ? (sysinfoMsg_size > aiModelInfoMsg_size ? sysinfoMsg_size : aiModelInfoMsg_size) : aiTensorMsg_size) : aiOperatorMsg_size) : aiDataMsg_size) : 140))
